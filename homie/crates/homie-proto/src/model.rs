//! Shared wire model ported from `HomieCore`.

use serde::{Deserialize, Deserializer, Serialize, Serializer, de};
use serde_json::{Map, Value};
use std::collections::BTreeMap;

/// A Foundation `Date` encoded by Homie as milliseconds since 1970.
...
///
/// Mirrors `HomieCore.AgentKind`, which stopped being a closed enum so that
