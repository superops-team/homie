//! The registry-backed tool host: `RegistryHost` and its `ToolHost` dispatch.
//!
//! This is the production implementation of [`super::super::ToolHost`] —
//! it runs MCP tool calls against the live session registry, spawns agents,
//! watches them, and reads their output.
...
use super::SESSION_ID_ENV;
use super::lineage::{Lineage, Relation, relation_word};
use crate::git;
