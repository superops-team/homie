...
- [Remote nodes](../homie/NODE.md) — run sessions over SSH and tmux.
- [Packaging](../homie/PACKAGING.md) — build, signing, and notarization.
- [Updates and releases](../homie/UPDATING.md) — updater design and release flow.
- [Rust engine port](../homie/PORT.md) — status of the cross-platform engine.
- [Performance](../homie/PERF.md) — budgets and measurement workflow.
